...
public class TartarusService {
    public static Flow parseFlow(String code) {
        ...
        ScriptToModelTransformer modelTransformer = new ScriptToModelTransformer();
        return (Flow) modelTransformer.visit(diagram);
    }

    public static String generateSVG(String code) {
        Flow flow = parseFlow(code);
